...
const JourneyDetails = () => {
    ...
    return (
        <div className="p-4 w-full mx-auto flex flex-col items-center">
           ...
           <h1 className="text-3xl font-bold mt-4 text-center text-white">{cardDetails.title}</h1>
            <h2 className="text-lg text-gray-200 text-center">{cardDetails.subTitle}</h2>
            <p className="mt-2 text-gray-300 text-center px-4 md:px-8">{cardDetails.description}</p>
           </div>
            </div>
